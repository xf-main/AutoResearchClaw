...
_DEFAULT_BLOCKS: dict[str, str] = {
    ...
    "dataset_guidance": (
        ...
        "- `torchvision.datasets.STL10(root='/workspace/data', split='train'/'test', download=False)`\n"
        "- `torchvision.datasets.SVHN(root='/workspace/data', split='train'/'test', download=False)`\n\n"
    ...
    "setup_script_guidance": (
        ...
        "main.py should only load data from /workspace/data using download=False.\n\n"
        "Example setup.py:\n"
        "```python\n"
        "import os\n"
